...
![Working build — servo mounted on its 3D-printed horn bracket, HC-SR04 wired in](./media/build-working.jpg)
![Mounted at a bin-edge position, hanging off the desk to simulate the real mount](./media/build-mounted-edge.jpg)
